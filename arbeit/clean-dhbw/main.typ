...
Diese Größen sind in der astronomischen und optischen Literatur formal definiert und bilden die Basis für photometrische Messungen. @wilson_era_2013 @pbrt_radiometry_2022 Im Photonenbild sind die folgenden Größen zentral @photonics_flux_2023:
...
Ist der Teleskopdurchmesser D deutlich kleiner als r₀, kann das System näherungsweise beugungsbegrenzt arbeiten; ist D deutlich größer als r₀, dominiert das Seeing, und die Auflösung wird nicht mehr durch die Optik, sondern durch die Atmosphäre begrenzt. @seeing_tutorial_2024
...
wobei 206 265 die Anzahl der Bogensekunden pro Radiant ist. @unittoolbox_pixel_2021
